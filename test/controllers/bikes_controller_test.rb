...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference("Bike.count") do
      post bikes_url, params: { bike: { brand: @bike.brand, usage: @bike.usage, wheels: @bike.wheels } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { brand: @bike.brand, usage: @bike.usage, wheels: @bike.wheels } }
